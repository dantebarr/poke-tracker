...
/**
 * A trainer's labels and daily target (#30, restyled to mockup B): every
 * mutation here is still its own plain form bound to a server action — no
 * client JavaScript is needed, so the screen works even before it hydrates.
 * Two sections mockup B never drew — Time zone and Session — get the same
 * `.setsection` treatment rather than being left on the old theme (#18's
 * rule for undrawn states).
 *
